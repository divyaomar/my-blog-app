...
const FeaturedPosts = () => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-12">
        <p className="text-[20px] tracking-wide text-gray-500 uppercase">Featured Posts</p>
        <h2 className="text-[24px] font-bold text-gray-800">Check Our Featured Posts</h2>
      </div>
          ...
          <div key={post.id} className="min-w-[300px] max-w-xs bg-white rounded-xl shadow-lg overflow-hidden relative">
            <div className="relative h-100">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent p-4 text-white flex flex-col justify-end">
                <div className="text-[15px] flex items-center gap-3 flex-wrap mb-2">
                ...
                <h3 className="text-[18px] font-semibold leading-tight pt-5">{post.title}</h3>
                <p className="text-[13px] text-gray-200 mt-1 line-clamp-2">{post.description}</p>
                <button className="mt-3 text-[14px] flex items-center gap-1 text-white hover:underline">
